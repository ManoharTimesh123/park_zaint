...
class TermsAndConditionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($row) {
                $editRoute = route('admin.terms-and-conditions.edit', $row->id);
                $viewRoute = route('admin.terms-and-conditions.show', $row->id);
                $deleteRoute = route('admin.terms-and-conditions.destroy', $row->id);
     ...
     */
    public function query(TermsAndConditions $model)
    {
